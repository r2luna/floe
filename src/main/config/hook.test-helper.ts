...
export async function load(url, context, next) {
  if (url === 'stub:electron') {
    return {
      format: 'module',
      shortCircuit: true,
      source: "export const app = { getPath: () => process.env.FLOE_TEST_USERDATA || '/tmp' }; export class BrowserWindow {}; export class WebContentsView {}; export const dialog = {}; export const shell = {}; export const clipboard = {}; export const nativeImage = {}; export const safeStorage = { isEncryptionAvailable: () => false }; export const ipcMain = { handle: () => {}, removeHandler: () => {} }; export default {};"
    }
  }
